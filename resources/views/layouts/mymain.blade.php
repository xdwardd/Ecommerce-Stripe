    ...
    <footer>
        ...
        <div class="subscribe">
          <div class="container align-center">
              ...
              <h1 class="h3 upp">Follow us on Social Media</h1>
            ...
            <div class="col-sm-3 col-md-3 col-md-offset-1 align-right hidden-sm hidden-xs">
              <h1 class="h4">E-istore, Inc.</h1>
                ...
                <address>
                  ...
                  <a href="mailto:#">xdwardd@example.com</a>
                </address>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-4 col-md-3 align-right align-center-xs">
              ...
              <hr class="offset-sm">
              <p>E-istore Pro © 2021 <br> Template By <a href="http://sunrise.ru.com/" target="_blank">Sunrise Digital</a>  
              <br>
              Modified By Edward Catapan
              </p>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="join" action="" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-12">
                      <textarea name="comment_text" placeholder="Type here" required="" class="form-control" rows="5"></textarea>
                      <br>
                  </div>
                  <div class="col-sm-6">
      ...
      <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCEkfOtUw7EXaFr6rst5gZSpZ3hzNEsB_4&callback=initMap"></script>


    <script>
      function initMap() {
        var mapDiv = document.getElementById('GoMap');
        var markerLatLng = {lat: 11.0128, lng: 123.9861};

        var map = new google.maps.Map(mapDiv, {
            center: {lat:11.0059 , lng: 124.0029},
            zoom: 12
        });

         var marker = new google.maps.Marker({
          position:{lat:11.0059 , lng: 124.0029},
          map: map,
          title: 'Edward'
        });
